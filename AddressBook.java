...
public class AddressBook {
    ...
    public static void list(HashMap<String, String> mapaCon) {
        ...
        {
            String llave = iterator.next(); // el iterador se llama llave que esta funcionando como referencia en el key
                                            // del hashmap

            System.out.println("  " + llave + "\t|\t" + mapaCon.get(llave)); // se muestra en pantalla el contenido del
                                                                             // hashmap
        }
    ...
    public static void delete(HashMap<String, String> mapaCon, String tel) {
        if (mapaCon.containsKey(tel)) // si el telefono existe se procede a removerlo del hashmap
        {
            ...
            mapaCon.remove(tel); // se remueven las coiincidencias con el dato clave
    ...
    public static void load(HashMap<String, String> m) {
        String inputFilename = "C:\\\\Users\\\\julio\\\\OneDrive\\\\Escritorio\\\\Repositorio\\\\input.csv";
    ...
    public static void save(HashMap<String, String> m) {
        ...
        try {
            ...
            while (iterator.hasNext()) // en un ciclo recorremos el hashmap
            {
                String llave = iterator.next(); // el iterador se llama llave que esta funcionando como referencia en el
                                                // key del hashmap
